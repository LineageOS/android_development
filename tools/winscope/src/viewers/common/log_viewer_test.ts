...
import {MockViewer} from '@viewers/common/mock_log_viewer';
import {MockPresenter} from '@viewers/common/mock_log_viewer_presenter';
...
import {LogFilterChangeDetail, LogTextFilterChangeDetail, TimestampClickDetail,} from './viewer_event_details';
