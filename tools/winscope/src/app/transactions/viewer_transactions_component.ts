...
import {UiData} from '@ui/transactions/ui_data';
...
@Component({
  ...
  styleUrls: ['./viewer_transactions_component.scss'],
})
export class ViewerTransactionsComponent extends LogViewerComponent<UiData> {
