...
public class SpareParts extends PreferenceActivity
    ...
    private void writeUIValuesToXML() {
        ...
        try {            
            ...
            android.util.Log.d("WYSIE", e.toString());
